# 🍰 NusratFoods - Premium Online Bakery
...
- **Live Site:** [NusratFoods Demo](https://scic-task-a09.vercel.app)
...
```bash
git clone https://github.com/ShahriarRefat0/SCIC-Task-A09.git
cd SCIC-Task-A09
```
...
```javascript
// Login logic
if (email === 'admin@NusratFoods.com' && password === 'admin123') {
  // Set cookie
...
For support, email shahriarrefat@example.com or open an issue in the GitHub repository.

---

<div align="center">
  <p>Made with ❤️ by Shahriar Refat</p>
